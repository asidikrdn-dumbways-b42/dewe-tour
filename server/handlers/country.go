...
// membuat struct handler sebagai tipe data untuk menampung interface CountryRepository dari package repositories
type handlerCountry struct {
	CountryRepository repositories.CountryRepository
}

// membuat function yang mengembalikan object berbentuk struct handleCountry, fungsi ini membutuhkan interface CountryRepository sebagai parameter, karena method-method dalam interface tersebut dibutuhkan di dalam method struct handleCountry
